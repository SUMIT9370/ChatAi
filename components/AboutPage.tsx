...
const SOCIALS = [
  ...
  ), link: 'https://www.linkedin.com/in/sumit-patil-582877240/' },
  { name: 'GitHub', icon: (
  ...
  ), link: 'https://github.com/SUMIT9370/ChatAi' },
  { name: 'LeetCode', icon: (
  ...
  ), link: 'https://leetcode.com/u/sumit_patil93/' },
];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#18181b] px-4 py-12 text-slate-100">
      <div className="bg-[#23232a] rounded-xl shadow-lg p-8 w-full max-w-md flex flex-col items-center">
        <div className="w-32 h-32 rounded-full border-4 border-white shadow mb-4 flex items-center justify-center bg-slate-700 text-slate-300 text-3xl font-bold">SP</div>
        <h1 className="text-2xl font-bold mb-1">Sumit Patil</h1>
